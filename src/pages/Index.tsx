...
const Index = () => {
  const [feeds, setFeeds] = useState<VideoFeed[]>([
    { id: "drone-1", name: "Drone Alpha", type: "drone", status: "online", currentView: "normal", videoUrl: "/rawfire (1).mp4" },
    { id: "drone-2", name: "Drone Beta", type: "drone", status: "online", currentView: "normal", videoUrl: "/sam2_masked_video_1739673702786 (1).mp4" },
    { id: "glasses-1", name: "Team Leader", type: "glasses", status: "online", currentView: "normal", videoUrl: "/rawfire-VEED (1).mp4" },
  ]);
